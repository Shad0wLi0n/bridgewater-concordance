		...
		return (
			<div className="row">
				...
				<form className="ten columns">
					<p>
					  To get started, upload text by direct input below. Please note, proper grammar must be used for the function to work properly, i.e. sentences must be capitalized and ended with a period. Leading and trailing whitespace will be stripped.
					</p>
